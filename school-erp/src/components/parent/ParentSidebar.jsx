...
const NAV_ITEMS = [
  ...
  {
    key: 'fees', label: 'Fee Payment', badge: 'fees',
  ...
  },
  {
    ...
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 6 2 18 2 18 9" /><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" /><rect x="6" y="14" width="12" height="8" /></svg>,
  },
  {
    key: 'notices', label: 'Notices', badge: 'notices',
...
export default function ParentSidebar({ activeKey, onNavigate, badges, students, currentStudentId, onStudentChange }) {
  const [mobileExpand] = useState(false);
  void mobileExpand;
  ...
  return (
    <aside className="parent-sidebar">
      <div className="sidebar-logo">
        ...
        <span className="sidebar-logo-text">Scolaris</span>
      </div>
          ...
          <li key={item.key}>
            ...
            >
              ...
              {item.badge && badges?.[item.badge] > 0 && (
                <span className="sidebar-nav-badge">{badges[item.badge]}</span>
              )}
            </div>
          </li>
        ))}
